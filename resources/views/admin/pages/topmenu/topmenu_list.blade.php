            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Top Menu Data</li>
                </ol>
              </div>
            </div>
            <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="card-title">Top Menu Data</h3>
                    ...
                    <div class="card-tools">
                      <ul class="pagination pagination-sm float-right">
                        ...
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('topmenu/export/pdf')}}">
                            <i class="fas fa-file-pdf" data-toggle="tooltip" data-html="true"title="Pdf"></i>
                          </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link" target="_blank" href="{{url('topmenu/export/excel')}}">
                        ...
                        @if(count($dataRow))
                            @foreach($dataRow as $row)  
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{url('topmenu/edit/'.$row->id)}}" type="button" class="btn btn-default">
                                                Edit 
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{url('topmenu/delete/'.$row->id)}}" type="button" class="btn btn-default">
                                                Delete 
