                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3"  placeholder="Enter Description" id="site_description" name="site_description"><?php 
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        if(isset($dataRow->site_map)){
                            ?>
                            value="{{$dataRow->site_map}}" 
                            <?php 
                        }
                        ?>
                        
                        class="form-control" placeholder="Enter Site Map Code" id="site_map" name="site_map">
                      </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
              ...
              <label>Choose Site Status</label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  
                                <?php 
                                if($dataRow->module_status=="Maintenance"){
                                    ?>
                                    checked="checked" 
                                    <?php 
                                }
                                ?>
                          id="module_status_1" name="module_status" value="Maintenance">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  
                                ...
                                ?>
                          id="module_status_2" name="module_status" value="Inactive">
